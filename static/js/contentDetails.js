...
function dynamicContentDetails(ob) {
  ...
  imgTag.src = ob.photos[0]; // Corrected line: set src, not id
  ...
  for (i = 0; i < ob.photos.length; i++) {
    ...
    imgTagProductPreviewDiv.onclick = function (event) {
      ...
      // imgTag.src = ob.photos[i]; // Removed redundant and potentially problematic line
      document.getElementById("imgDetails").src = this.src; // Now works correctly
    };
